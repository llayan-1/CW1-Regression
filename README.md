...
The submission file is generated by the script and treated as a build artifact; it is excluded from version control via `.gitignore`.

---

## Evaluation Protocol

All models were trained using a fixed random seed to ensure reproducibility of results.
...
* Performance is evaluated using out-of-sample **R²**.
